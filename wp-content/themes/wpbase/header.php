	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			if ( $wpbase_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $wpbase_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->

		<nav id="site-navigation" class="main-navigation resetList">
